...
- the committed AGENTS.md is exactly what `govflags.nyx` generates (G-5, drift);
- the generated policy carries the rules the BRD requires (G-1..G-4).
"""
...
def test_generated_policy_carries_brd_rules(tmp_path):  # G-1..G-4
    out = tmp_path / "gen"
